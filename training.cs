...
{//start of namespcae
    ...
    {//start of training class
        ...
        {//start of training data class
            public string Question { get; set; }
            public string Answer { get; set; }
        }//end  of  training data class
        ...
        {//start of answerprediction
            [ColumnName("PredictedLabel")]
            public string PredictedAnswer { get; set; }
            public float[] Score { get; set; }
        }//end of answer prediction
        ...
        {//start of check and learn method
